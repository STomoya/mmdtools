...
class Environment:
    ...
    def view_matrix(self) -> np.ndarray:
        """Camera matrix"""
        return matrix44.create_look_at(self.camera.position, self.camera.target, self.camera.up, dtype=np.float32)

    @property
    def projection_matrix(self) -> np.ndarray:
        """Perspective projection matrix"""
        return matrix44.create_perspective_projection(
            self.projection.fovy, self.projection.aspect, self.projection.near, self.projection.far, dtype=np.float32
        )
    ...
    def set_light(
        ...
        *,
        ...
        ambient: Vector3D | None = None,
        diffuse: Vector3D | None = None,
        specular: Vector3D | None = None,
    ) -> None:
    ...
    def set_camera(
        self, *, position: Vector3D | None = None, target: Vector3D | None = None, up: Vector3D | None = None
    ) -> None:
...
class Camera:
    ...
    def __init__(
        self,
        position: Vector3D = (0.0, 10.0, -30.0),
        target: Vector3D = (0.0, 10.0, 0.0),
...
class Projection:
    ...
    def __init__(self, fovy: float = 45.0, aspect: float = 1.0, near: float = 0.1, far: float = 50.0) -> None:
